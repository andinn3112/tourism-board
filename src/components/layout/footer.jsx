...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-gradient-to-b from-zinc-900 to-zinc-950 text-white overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-amber-600 via-amber-300 to-red-800"></div>
          ...
          <div className="lg:col-span-5">
            <div className="flex gap-3 mb-6">
              <div>
                ...
                <h2 className="text-2xl font-bold bg-gradient-to-r from-amber-400 to-amber-800 bg-clip-text text-transparent">
                  {SITE_NAME}
                </h2>
          ...
          {[
            {
              title: "Destinasi",
              links: [
                { label: "Pantai", href: "/destinasi?kategori=wisata" },
                { label: "Gunung", href: "/destinasi?kategori=kuliner" },
                { label: "Danau", href: "/destinasi?kategori=Transportasi" },
                { label: "Kota Tua", href: "/destinasi?kategori=event" },
                {
                  label: "Air Terjun",
                  href: "/destinasi?kategori=air-terjun",
                },
              ],
            },
            {
